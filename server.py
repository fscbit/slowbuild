...
# 八字命盘引擎
from backend.bazi import calculate_bazi
from backend.astro import build_full_chart, get_daily_horoscope
from backend.numerology import build_numerology_report
from backend.fengshui import get_kua, get_home_advice
from backend.tarot import get_spread_reading
from backend.iching import get_reading
from backend.palm_reading import get_palm_reading
from backend.name_analysis import analyze_name
